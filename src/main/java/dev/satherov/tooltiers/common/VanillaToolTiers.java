...
public class VanillaToolTiers {
    ...
    public static final ToolTier GOLD = ToolTier.create("gold", 0xFFD700, 4);
    public static final ToolTier DIAMOND = ToolTier.create("diamond", 0x00FFFF, 5);
    public static final ToolTier NETHERITE = ToolTier.create("netherite", 0x39373A, 6);
}
